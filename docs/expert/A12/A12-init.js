...
$('#q3-button').on('click', function () {
    ...
    // 平日と週末に分けて時間割を作成してください。
    // 対象学年はプログラミング: 小2-中3、エキスパート: 小5-高3、イノベーター: 小5-大学生
    // -- ここに記載 --
})
